...
ok("version 1.1.26", read("utils/app.version").strip() == "1.1.26")
...
ok("new vpn.dance IP", "31.56.188.10" in vless)
ok("new vpn.dance uuid", "924cec67-bb91-411c-9821-a78d14022786" in vless)
ok("Reality SNI play.google.com", "play.google.com" in vless)
ok("old intezio2 gone", "intezio2.vpn.dance" not in vless and "217.60.25.237" not in vless)
